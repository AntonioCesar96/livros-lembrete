package livroslembrete.com.br.livroslembrete.rest;
...
public class LivroService {
    ...
    public RespostaUploadImagem postFotoBase64(File file) throws IOException {
        ...
        return new Gson().fromJson(json, RespostaUploadImagem.class);
    }
}
